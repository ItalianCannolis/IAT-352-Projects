...
<navigation>
  ...
  <ul class="subjects">
    ...
    <li><a href="<?php echo url_for('/language.php?') ?>">Set Language</a></li>
    <li><a href="<?php echo url_for('/staff/login.php?') ?>">Staff Login</a></li>
    <li><a href="<?php echo url_for('/staff/register.php?') ?>">Staff Register</a></li>
  </ul>
